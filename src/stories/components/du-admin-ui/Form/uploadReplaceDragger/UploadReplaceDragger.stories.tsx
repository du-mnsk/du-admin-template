...
import type { FormUploadReplaceDraggerProps } from '@/shared/components/du-admin-ui/Form/uploadReplaceDragger'

// 스토리북에서 컴포넌트 이름을 "Form.UploadReplaceDragger"로 표시
if (Form.UploadReplaceDragger) {
  (Form.UploadReplaceDragger as any).displayName = 'Form.UploadReplaceDragger'
}

const meta = {
  title: 'Common/Form/Form.UploadReplaceDragger',
  component: Form.UploadReplaceDragger,
  parameters: {
    layout: 'padded',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof Form.UploadReplaceDragger>
...
export const Default: Story = {
  args: {
    imgPath: '/upload',
    previewImage: '',
    imgUploadRequest: undefined,
    setImgUploadRequest: () => {},
  },
  render: (args: FormUploadReplaceDraggerProps) => {
